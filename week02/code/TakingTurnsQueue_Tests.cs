...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: the Person Queue Class was queueing the people as an stack  _queue.Insert(0, person);
    ...
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: 
    // 1. it was not enqueueing the people with infinite turns back into the queue.
    ...
    // Defect(s) Found: 1. it was not enqueueing the people with negative turns back into the queue.
